              ...
              return (
                <div className="overflow-x-auto my-4">
                  <table className="min-w-full divide-y divide-gray-300 border border-gray-200">
                    {children} {/* ✅ FIXED: wrapped children in JSX */}
                  </table>
                </div>
              );
            },
            thead({ children }) {
              return <thead className="bg-gray-50">{children}</thead>; // ✅ FIXED: wrap children in JSX
            },
            tbody({ children }) {
...
// ✅ FIXED: wrapped JSX properly & removed extra div
